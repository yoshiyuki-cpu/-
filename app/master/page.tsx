  ...
  return (
    <div>
      ...
      <div className="flex gap-1.5 mb-3 overflow-x-auto pb-1 -mx-4 px-4">
        ...
        <Link href="/disposal" className="shrink-0 whitespace-nowrap text-sm text-blue-600 border border-gray-200 bg-white rounded-full px-3 py-1.5">🚛 処分場・車両などの月の合計</Link>
